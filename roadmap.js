...
const RESOURCE_LINKS = {
  ...
  'YouTube: Pengenalan SIEM':'https://youtu.be/9RfsRn7m7OE?si=BkjKLLyJVYVx7660',
  'Artikel: SIEM architecture basics':'https://www.sentinelone.com/cybersecurity-101/data-and-ai/siem-architecture/',
  'Tools: Splunk Free':'https://www.splunk.com/en_us/get-started.html',
  'YouTube: Windows Event Log':'https://youtu.be/-fV7jZwZuGQ?si=VeiwT1gxMbpSXmcY',
  'Artikel: Syslog basics':'https://www.crowdstrike.com/en-us/guides/syslog-logging/',
  'Artikel: Cloud log sources':'https://logz.io/glossary/cloud-log-management/',
  'YouTube: SPL query basics':'https://youtu.be/vRRXnt89y7E?si=Tkm33sMTaXJE85OV',
  'YouTube: KQL basics':'https://youtu.be/ImqRQJfnSHM?si=C4WL8bnDJXpmuPQ-',
  'Tools: Microsoft Sentinel':'https://www.microsoft.com/en-us/security/business/siem-and-xdr/microsoft-sentinel',
  'Artikel: Correlation rule tuning':'https://cymulate.com/cybersecurity-glossary/siem-correlation-rules/',
  'YouTube: Reducing false positives in SIEM':'https://youtu.be/3-erb-7bh0s?si=hYPLsBxexOxc9CQJ',
  'Tools: Elastic SIEM':'https://www.elastic.co/',
  'Artikel: Log retention policy':'https://www.groundcover.com/learn/logging/log-retention-policies',
  'Artikel: SIEM archiving and compliance':'https://www.sentinelone.com/cybersecurity-101/data-and-ai/siem-compliance/',
  'Tools: Splunk BOTS':'https://bots.splunk.com/login?redirect=/',
  
  'YouTube: Incident response lifecycle':'https://youtu.be/4MGVTpXAAmo?si=Y7wIw23lUmuXlfEX',
  'Artikel: PICERL incident response':'https://www.sans.org/media/score/504-incident-response-cycle.pdf',
  'DFIR.training':'https://www.dfir.training/',
  'Artikel: Incident severity classification':'https://www.atlassian.com/incident-management/kpis/severity-levels',
  'YouTube: Escalation matrix basics':'https://youtu.be/K8C7CeTs93k?si=zQt6rf0B_vW40Bl5',
  'CyberDefenders':'https://cyberdefenders.org/',
  'Artikel: IR playbook examples':'https://www.cisa.gov/sites/default/files/2024-08/Federal_Government_Cybersecurity_Incident_and_Vulnerability_Response_Playbooks_508C.pdf',
  'YouTube: Ransomware response playbook':'https://youtu.be/nhb_GEagMUk?si=Xp8MF9SC2sdYnngX',
  'Tools: TheHive':'https://strangebee.com/thehive/',
  'Artikel: Order of volatility':'https://clocked-out.com/what-is-order-of-volatility/',
  'Artikel: Chain of custody basics':'https://nij.ojp.gov/nij-hosted-online-training-courses/law-101-legal-guide-forensic-expert/pretrial/pretrial-motions/chain-custody',
  'DFIR.training':'https://www.dfir.training/',
  'YouTube: SOAR basics':'https://youtu.be/k7ju95jDxFA?si=geRJDnFqvnGq5273',
  'Artikel: Automating incident response':'https://www.threatintelligence.com/blog/automated-incident-response',
  'Tools: Shuffle SOAR':'https://shuffler.io/',
  
  'Artikel: Order of volatility':'https://www.ietf.org/rfc/rfc3227.txt',
  'YouTube: Digital forensics basics':'https://youtu.be/w2xItujdLag?si=kOI_8mm5dyUBzEQB',
  'Artikel: Evidence collection basics':'https://www.ncbi.nlm.nih.gov/books/NBK441852/',
  'YouTube: Disk imaging basics':'https://youtu.be/jrJTQF3o5c4?si=E9CzpKnHSBByihTb',
  'Tools: FTK Imager':'https://www.exterro.com/digital-forensics-software/ftk-imager',
  'Artikel: dd dan dcfldd forensics':'https://www.forensics-matters.com/2020/10/20/simple-forensics-imaging-with-dd-dc3dd-dcfldd/',
  'YouTube: Volatility 3 basics':'https://youtu.be/Uk3DEgY5Ue8?si=c0OYjrA_JL9HKKHE',
  'Tools: Volatility 3':'https://volatilityfoundation.org/',
  'Artikel: Memory forensics introduction':'https://hadess.io/memory-forensic-a-comprehensive-technical-guide/',
  'Artikel: Timeline reconstruction basics':'https://dfrws.org/wp-content/uploads/2025/05/SoK-Timeline-based-event-reconstruction-for-digital-forensics-Terminology-methodology-and-current-challenges.pdf',
  'Tools: Plaso':'https://github.com/log2timeline/plaso',
  'YouTube: Log2timeline tutorial':'https://youtu.be/sAvyRwOmE10?si=mpgODNPOebjlHQPs',
  'YouTube: Network forensics basics':'https://youtube.com/playlist?list=PLkb5lfjv-rnDZ-13i13BTRIdhXoGeyT99&si=195tYf-yUD90iDBM',
  'Tools: NetworkMiner':'https://www.netresec.com/?page=NetworkMiner',
  'Artikel: PCAP analysis guide':'https://medium.com/@DaRkrAi69/pcap-analysis-using-wireshark-1-d69d0e107367',
  
  'MITRE ATT&CK Navigator':'https://mitre-attack.github.io/attack-navigator/',
  'YouTube: Cara pakai MITRE ATT&CK':'https://youtu.be/78RIsFqo9pM?si=HU-VssBcQeyXSncL',
  'Artikel: ATT&CK tactics and techniques':'https://attack.mitre.org/',
  'YouTube: Threat hunting basics':'https://youtu.be/VNp35Uw_bSM?si=I9VIvC6GX8xPYGgo',
  'Artikel: Hypothesis-driven threat hunting':'https://bloo.io/resources/articles/hypothesis-driven-threat-hunting',
  'Artikel: TTP-based hunting':'https://www.mitre.org/sites/default/files/2021-11/prs-19-3892-ttp-based-hunting.pdf',
  'Artikel: Indicator of Compromise basics':'https://medium.com/@scottbolen/tutorial-understanding-indicators-of-compromise-iocs-and-implementing-into-cyber-threat-53a0fcfb386e',
  'YouTube: IOC extraction':'https://youtu.be/TOyfjO2zdLU?si=rOG4ukFYf4SoqqC6',
  'Tools: IntelOwl':'https://intelowlproject.github.io/',
  'Tools: Shodan':'https://www.shodan.io/',
  'Artikel: OSINT untuk threat intel':'https://suhu.co.id/kata-suhu/apa-itu-osint-ini-tools-osint-terbaik-untuk-cyber-security-threat-intelligence',
  'YouTube: Threat research with VirusTotal and Censys':'https://youtu.be/Sf2UdT53yFw?si=XYij_Sdy20MucOuZ',
  'Tools: OpenCTI':'https://filigran.io/platform/opencti/',
  'Tools: MISP':'https://www.misp-project.org/',
  'Artikel: STIX TAXII basics':'https://deepstrike.io/blog/what-are-stix-taxii-standards',
  
  'Artikel: AI for alert triage':'https://swimlane.com/blog/ai-alert-triage/',
  'YouTube: AI in SOC operations':'https://youtu.be/xdUR8-_P3DU?si=CpuDKo5WF4hDwJq2',
  'Tools: Microsoft Copilot for Security':'https://www.microsoft.com/en-us/security/business/ai-machine-learning/microsoft-security-copilot',
  'Artikel: LLM for threat hunting':'https://ctid.mitre.org/events/apac-2025/08%20-%20MITRE%20ATT&CK%20Driven%20Threat%20Hunting%20Automated%20by%20Local%20LLM.pdf',
  'YouTube: Natural language SIEM query':'https://youtu.be/aK_rFcKW4mY?si=kgDZ_yqyo7pWRZHk',
  'Tools: Google Chronicle AI':'https://cloud.google.com/blog/products/identity-security/rsa-introducing-ai-powered-investigation-chronicle-security-operations',
  'Artikel: Agentic AI for SOAR':'https://cloud.google.com/security/resources/agentic-soc',
  'YouTube: Autonomous incident response':'https://youtu.be/8ycPNnHmc1E?si=SrhMEzZZogk8x_a6',
  'Tools: Microsoft Copilot for Security':'https://www.microsoft.com/en-us/security/business/ai-machine-learning/microsoft-security-copilot',
  'Artikel: AI threat intelligence summarization':'https://www.sciencedirect.com/science/article/abs/pii/S0167404826001045',
  'YouTube: AI-assisted threat intel':'https://youtu.be/9wgsGPA_NhA?si=7DPrWRJvlxIA3lL6',
  'Tools: CrowdStrike Charlotte AI':'https://www.crowdstrike.com/en-us/platform/charlotte-ai/',
  'Artikel: Human in the loop security operations':'https://www.ibm.com/think/topics/human-in-the-loop',
  'YouTube: Limits of AI in SOC':'https://youtu.be/V8UN7owZFA0?si=HTqR5IqQPVs5dhmv',
  'Artikel: AI governance in security operations':'https://seceon.com/ai-governance-in-cybersecurity-building-trust-and-resilience-in-the-age-of-intelligent-security/',

  'OWASP LLM Guide':'https://owasp.org/www-project-top-10-for-large-language-model-applications/assets/PDF/OWASP-Top-10-for-LLMs-v2025.pdf',
  'Tools: GANDALF AI (Lakera)':'https://gandalf.lakera.ai/baseline',
  'Lab: Prompt Injection':'https://portswigger.net/web-security/llm-attacks/lab-indirect-prompt-injection',
  'OWASP LLM Guide':'https://owasp.org/www-project-ai-testing-guide/',
  'Artikel: Sensitive information disclosure pada LLM':'https://genai.owasp.org/llmrisk/llm022025-sensitive-information-disclosure/',
  'YouTube: PII leakage pada AI':'https://youtu.be/jY5X9Kk2mBs?si=UdTV3To6bn5AGGyJ',
  'OWASP LLM Guide':'https://youtu.be/cYuesqIKf9A?si=CC-s57HYMMl_4SBP',
  'Artikel: Excessive agency pada agentic AI':'https://genai.owasp.org/llmrisk/llm062025-excessive-agency/',
  'YouTube: AI agent overreach':'https://youtu.be/exjhaHmZk8g?si=QDVtDUiAO8CJ0U0A',
  'OWASP LLM Guide':'https://www.youtube.com/live/dj1H4g4YSlU?si=FlRBiyb4_NwCA6FY',
  'Lab: System Prompt Leakage':'https://genai.owasp.org/llmrisk/llm072025-system-prompt-leakage/',
  'Tools: PortSwigger AI Labs':'https://portswigger.net/web-security/llm-attacks',
  'OWASP LLM Guide':'https://youtu.be/zoOQUFrrA2w?si=27G4-G7vqKp_mfpu',
  'Artikel: Hallucination dan misinformation pada LLM':'https://genai.owasp.org/llmrisk/llm092025-misinformation/',
  'YouTube: Risiko misinformation pada AI':'https://youtu.be/A-YHW6C6k_Y?si=GmI1KVrKniu9xybX',
  
  'OWASP AI Exchange':'https://owaspai.org/',
  'Artikel: Apa itu Agentic AI':'https://cloud.google.com/discover/what-is-agentic-ai?hl=id',
  'YouTube: Agentic AI basics':'https://youtu.be/FwOTs4UxQS4?si=NlnfmNpMY4S2_mgR',
  'OWASP AI Exchange':'https://owaspai.org/',
  'Artikel: Agent goal hijacking':'https://learn.snyk.io/lesson/agent-goal-hijack/?ecosystem=aiml',
  'YouTube: Goal hijacking pada AI agent':'https://youtu.be/49tji8u2wM4?si=j7ymZhOsuvXbXA7S',
  'Anthropic Red Team Resources':'https://red.anthropic.com/',
  'Artikel: Tool misuse pada multi-agent systems':'https://learn.snyk.io/lesson/agent-tool-misuse-and-exploitation/?ecosystem=aiml',
  'YouTube: Identity abuse in AI systems':'https://youtu.be/wiU7VEvi1LM?si=JCqNr877AQtbr0Q6',
  'OWASP AI Exchange':'https://owaspai.org/',
  'Artikel: Memory poisoning pada AI agent':'https://arxiv.org/abs/2601.05504',
  'YouTube: Long-term memory attacks':'https://youtu.be/5ZWJxsjeLhw?si=3XythAN8LKuzigB4',
  'GitHub Secure Code Game Season 4':'https://github.com/skills/secure-code-game',
  'Artikel: MCP security basics':'https://modelcontextprotocol.io/docs/tutorials/security/security_best_practices',
  'YouTube: Model Context Protocol security':'https://youtu.be/eur8dUO9mvE?si=xiYon2UNI32ppMY5',
  
  'Adversarial Robustness Toolbox':'https://adversarial-robustness-toolbox.org/',
  'CleverHans':'https://cleverhans.io/',
  'YouTube: Adversarial attack basics':'https://youtu.be/Xe_ShxUtuMo?si=EPzKAlIqPovPS5hu',
  'Artikel: Data poisoning attacks':'https://www.crowdstrike.com/en-us/cybersecurity-101/cyberattacks/data-poisoning/',
  'YouTube: Data poisoning pada AI':'https://youtu.be/Lolub-mJHFk?si=-Tmfq7TXIyDvBxh8',
  'AI Verify Foundation':'https://aiverifyfoundation.sg/',
  'Artikel: Model extraction attacks':'https://ssg-research.github.io/mlsec/modelExtDef',
  'Artikel: Model inversion attacks':'https://owasp.org/www-project-machine-learning-security-top-10/docs/ML03_2023-Model_Inversion_Attack',
  'YouTube: Model theft and inversion':'https://youtu.be/gfatktR4kKY?si=lRr3mVS1R1l5CAED',
  'AI Verify Foundation':'https://aiverifyfoundation.sg/',
  'Artikel: AI supply chain security':'https://www.pointguardai.com/glossary/ai-supply-chain-security',
  'YouTube: Securing model and dataset integrity':'https://youtu.be/2A94Mxn3jAc?si=nbpYVE7yRi5AwjIV',
  'Artikel: AI SBOM basics':'https://jozu.com/blog/how-to-generate-an-ai-sbom-and-what-tools-to-use/',
  'YouTube: Software Bill of Materials untuk AI':'https://youtu.be/AnK9u2zGM14?si=5EaEP06jvulJg0ig',
  'AI Verify Foundation':'https://aiverifyfoundation.sg/',
  
  'ISO 42001 Guide':'https://www.iso.org/home/insights-news/resources/iso-42001-explained-what-it-is.html',
  'Artikel: ISO 42001 overview':'https://www.aigl.blog/iso-iec-42001-implementation-guide-ai-management-system/',
  'YouTube: AI Management System basics':'https://youtube.com/playlist?list=PL737lWkWtq6vJQUq4b1yN6-kEGGxtgoHs&si=zehnM4As0EyfYWY_',
  'EU AI Act Portal':'https://artificialintelligenceact.eu/',
  'Artikel: EU AI Act overview':'https://www.ibm.com/think/topics/eu-ai-act',
  'YouTube: EU AI Act explained':'https://youtu.be/s_rxOnCt3HQ?si=vP87PO0YNBNBr2qq',
  'NIST AI RMF Docs':'https://www.nist.gov/itl/ai-risk-management-framework/nist-ai-rmf-playbook',
  'Artikel: NIST AI RMF overview':'https://medium.com/@akitrablog/a-short-guide-on-nist-ai-risk-management-framework-ai-rmf-616f7494a067',
  'YouTube: NIST AI RMF basics':'https://youtu.be/0oeD2Wf25wY?si=fP7o54FAfGDh9cSn',
  'Artikel: AI Impact Assessment':'https://www.aigl.blog/ai-impact-assessment-the-tool-for-a-responsible-ai-project/',
  'Artikel: Algorithmic auditing basics':'https://www.businessofgovernment.org/sites/default/files/Algorithmic%20Auditing.pdf',
  'YouTube: Menyusun AI impact assessment':'https://youtube.com/playlist?list=PLLWjuKthwbzuai3k50mQpjjBWdYBOKhdz&si=gHVLofLnAcm6XKqt',
  'Artikel: Kebijakan AI Indonesia':'https://www.ekon.go.id/publikasi/detail/6544/perkuat-pengambilan-kebijakan-berbasis-data-pemerintah-manfaatkan-kecerdasan-buatan',
  'Dokumen: Peta jalan AI nasional':'https://s.komdigi.go.id/KonsultasiPublik_KA',
  'YouTube: Regulasi AI di Indonesia':'https://youtu.be/DeYhEG1svUo?si=tY9cE6qOcFKBe-JT',
  
  'Lakera Guard':'https://www.lakera.ai/',
  'Artikel: Securing LLM APIs':'https://medium.com/walmartglobaltech/managing-secure-api-access-to-llms-in-distributed-systems-with-dataflow-d895e11b8912',
  'YouTube: LLM API security basics':'https://youtu.be/oYJD_fE8a1U?si=8gXVeM_M2cd7U2yH',
  'Artikel: RAG security basics':'https://www.paloaltonetworks.com/cyberpedia/what-is-retrieval-augmented-generation',
  'YouTube: Vector database poisoning':'https://youtu.be/mnf5IpNUHg8?si=jbjhHNyjGK6Zdufz',
  'Portkey AI Gateway':'https://portkey.ai/features/ai-gateway',
  'Wiz AI Security':'https://www.wiz.io/academy/ai-security',
  'Artikel: Access control untuk AI systems':'https://budibase.com/blog/ai-agents/ai-access-control/',
  'YouTube: Authentication in AI infrastructure':'https://youtu.be/wiU7VEvi1LM?si=bgpzK2vuQ9m9hweB',
  'Artikel: AI observability basics':'https://konghq.com/blog/learning-center/guide-to-ai-observability',
  'YouTube: Monitoring AI workloads':'https://youtu.be/uA4pBu8leyU?si=ecp15Lf22LtJIEDp',
  'Wiz AI Security':'https://www.wiz.io/academy/ai-security',
  'Artikel: AI Security Posture Management':'https://www.paloaltonetworks.com/cyberpedia/ai-security-posture-management-aispm',
  'Lakera Guard':'https://www.lakera.ai/',
  'Portkey AI Gateway':'https://portkey.ai/features/ai-gateway',
